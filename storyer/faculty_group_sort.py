...
class GroupSort():
    ...
    def __init__(self, course_id,  debug):
    ...
    def handle(self, *args, **options):
        ...
        if self.debug:
            ...
            for student in students:
                print(student)
                print(student.preference_set.filter(
                    group_preference__course=course).order_by('priority'))
                print()
                    ...
                    if group_students.count() < minGroupSize:
                        ...
                        for student in students:
                            if not student.group.filter(course=course).exists():
                                ...
                                student_preference = Preference.objects.get(
                                    student_id=student.id, group_preference__course=course, priority=priority)
        ...
        if self.debug:
            ...
            for group in groups:
                ...
                for student in group.assigned_group.all():
                    print(student, ", priority for ",
                          student.preference_set.get(group_preference=group))
                print()
            print("num students in groups: ",
                  studentsInGroup, "/", numStudents)
